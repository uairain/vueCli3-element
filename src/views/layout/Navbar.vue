<template>
  ...
  <el-menu class="navbar"
    ...
    <el-dropdown class="avatar-container"
                 trigger="click">
      <div class="avatar-wrapper"> <img class="user-avatar"
             :src="avatar+'?imageView2/1/w/80/h/80'"> <i class="el-icon-caret-bottom"></i> </div>
      <el-dropdown-menu class="user-dropdown"
        ...
        <a target='_blank'
           href="https://github.com/wxiaoqi/ace-admin/">
