  ...
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey'
      ...
      <el-table-column fixed="right"
                       ...
                       width="150">
        <template slot-scope="scope">
          <el-button v-if="serviceManager_btn_edit"
                     size="small"
                     type="success"
                     @click="handleUpdate(scope.row)">编辑
          </el-button>
          <el-button v-if="serviceManager_btn_del"
                     size="small"
                     type="danger"
      ...
      <el-form :model="form"
        ...
        <el-form-item label="服务编码"
          ...
          <el-input v-model="form.code"
                    placeholder="请输入服务编码"></el-input>
        </el-form-item>
        <el-form-item label="服务密钥"
                      prop="secret">
          <el-input v-model="form.secret"
                    placeholder="请输入服务密钥"></el-input>
        </el-form-item>
    ...
    <el-dialog :title="dialogClientName"
               :visible.sync="dialogClientVisible">
      <service-client :serviceId="currentId"
